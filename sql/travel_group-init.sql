...
DROP TABLE IF EXISTS `travel_introduction`;
CREATE TABLE `travel_introduction` (
    `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
    `scenic_id` int DEFAULT NULL COMMENT '景点id',
    `title` text COMMENT '主题',
    `font_image` text COMMENT '图片',
    `notice` text COMMENT '间接说明',
