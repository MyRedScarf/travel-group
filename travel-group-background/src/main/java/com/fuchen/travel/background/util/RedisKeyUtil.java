...
public class RedisKeyUtil {
	...
	private static final String PREFIX_SCENIC_RECOMMEND = "scenicRe";
	 ...
	 * @return
	 */
	public static String getScenicReKey(Integer scenicId) {
		return PREFIX_SCENIC_RECOMMEND + SPLIT + scenicId;
	}
